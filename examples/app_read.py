...
parser.add_argument('--node', '-n', type=int, dest="lan_dir", help="Dirección del nodo del que se quiere bajar el programa.")
parser.add_argument('--file', '-f', type=str, dest="file_name", help="Nombre del archivo HEX de destino.")
