...
parser.add_argument('--node', '-n', type=int, dest="lan_dir", help="Dirección del nodo que se quiere grabar.")
parser.add_argument('--file', '-f', type=str, dest="file", help="Nombre del archivo HEX que tiene el programa.")
